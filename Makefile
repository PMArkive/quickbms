...
CLIBS	+= -static-libgcc -static-libstdc++ -lstdc++ -lm -lpthread
PREFIX	= /usr/local
BINDIR	= $(PREFIX)/bin
SRC		= $(EXE).c
...
EXTRA_TARGETS	= libs/amiga/amiga.s
USE_OPENSSL	= 1
endif
